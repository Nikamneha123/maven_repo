...
/*public class GenericUtils extends Ecommerce_BaseClass{
	...
	//	File src=TS.getScreenshotAs(OutputType.FILE);
		...
		String dest=absolutePath+"//Screenshot//" + testcasename + "" + Name + ".png";
		//String dest="C:\\Users\\admin\\eclipse-workspace\\Maven_project\\Screenshot.png";
...
public class GenericUtils extends Ecom_BaseClass {
